...
const Stopwatch = ({ color = "blue" }) => {
  ...
  return (
    <div
      className={`flex flex-row justify-center gap-4 bg-${color}-100 p-6 md:p-10 rounded-md  md:w-72 font-mono font-semibold`}
    >
      <div className="flex flex-col gap-4">
        <span className="col-span-3 row-span-1 text-3xl md:text-5xl text-center w-56">
          {formatTime(time)}
        </span>
